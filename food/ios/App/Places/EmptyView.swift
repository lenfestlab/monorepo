...
class EmptyView: UIView {
  ...
  override func layoutSubviews() {
    ...
    self.emptyTitleLabel.frame = CGRect(x: padding, y: self.emptyImageView.frame.maxY + 24, width: labelWidth, height: 21)
    ...
    self.clearButton.center = CGPoint(x: self.center.x, y: self.emptySubtitleLabel.frame.maxY + 65)
  }
